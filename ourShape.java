...
public class ourShape implements Iterable <Point> {
	...
	// circular list of rotations
	 public ourShape rotate;

	// internal constructor
	public ourShape(Set <Point> points, ourShape rotate)
	{
		this.points = points;
		this.rotate = rotate;
	...
	public ourShape(Point[] points)
	{
		...
		if (points_0.equals(points_1))
			...
			rotate = new ourShape(points_1, this);
		else
			rotate = new ourShape(points_1,
			         new ourShape(points_2,
			         new ourShape(points_3, this)));
	}
	...
	public boolean equals(ourShape shape)
	{
